        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#c9a962] to-[#e8d5a3] flex items-center justify-center shadow-lg">
                <span className="text-[#1e3a5f] font-display font-bold text-xl">VV</span>
              </div>
              <div>
                <h3 className="font-display font-semibold text-xl">Vacation Village</h3>
                <p className="text-[#c9a962] text-sm tracking-wider">CHIKKAMAGALURU</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              {[Facebook, Instagram, Linkedin, Youtube].map((Icon, index) => (
                <a
                  key={index}
                  href="#"
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#c9a962] transition-all duration-300 group"
                >
                  <Icon className="w-5 h-5 text-gray-300 group-hover:text-[#1e3a5f] transition-colors" />
                </a>
              ))}
            </div>
          </div>
            ...
            <nav className="flex flex-col gap-3">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-gray-300 hover:text-[#c9a962] transition-colors flex items-center gap-2 group"
                >
                  <ChevronRight className="w-4 h-4 text-[#c9a962] opacity-0 group-hover:opacity-100 transition-opacity" />
                  {link.name}
                </a>
              ))}
            </nav>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <a
                ...
                className="flex items-start gap-3 text-gray-300 hover:text-[#c9a962] transition-colors"
              >
              ...
              <a
                ...
                className="flex items-start gap-3 text-gray-300 hover:text-[#c9a962] transition-colors"
              >
                <Globe className="w-5 h-5 text-[#c9a962] flex-shrink-0 mt-0.5" />
          ...
          <div>
            ...
            <div className="bg-white/5 rounded-xl p-5">
              <h5 className="font-semibold text-[#c9a962] mb-2">Agrocorp Landbase (P) Limited</h5>
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm text-gray-400">
              ...
              <a href="#" className="hover:text-[#c9a962] transition-colors">Disclaimer</a>
            </div>
          </div>
        </div>
      </div>
