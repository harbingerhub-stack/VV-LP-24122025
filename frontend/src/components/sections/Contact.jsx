        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            ...
            <div className="space-y-6 mb-10">
              <a href={`tel:${contactData.phone}`} className="flex items-center gap-4 text-white hover:text-[#87b04a] transition-colors">
              ...
              <a href={`mailto:${contactData.email}`} className="flex items-center gap-4 text-white hover:text-[#87b04a] transition-colors">
                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
          ...
          <div className={`transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
            <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-8 md:p-10 shadow-2xl">
              <h3 className="font-display text-2xl text-[#084a61] mb-6">Schedule a Site Visit</h3>
