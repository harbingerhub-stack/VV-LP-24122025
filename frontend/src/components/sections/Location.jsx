      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="glass rounded-xl p-4 flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1e3a5f]">Hebballi, Chikkamagaluru</h4>
            ...
            {/* Distance Cards */}
            <div className="absolute -top-4 -right-4 bg-[#1e3a5f] text-white rounded-xl p-4 shadow-xl hidden md:block">
          ...
          <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
            <Tabs defaultValue="connectivity" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-8 bg-[#f8f7f4] p-1 rounded-xl">
                <TabsTrigger 
                  value="connectivity" 
                  className="rounded-lg data-[state=active]:bg-[#1e3a5f] data-[state=active]:text-white transition-all"
                >
              ...
              <TabsContent value="connectivity" className="mt-0">
                <div className="bg-[#f8f7f4] rounded-2xl p-6">
                  <h4 className="font-display font-semibold text-lg text-[#1e3a5f] mb-4 flex items-center gap-2">
                  ...
                  <div className="space-y-3">
                    {locationData.distances.map((item, index) => (
                      <div
                        key={item.place}
                        className="flex items-center justify-between py-3 border-b border-[#e8d5a3]/30 last:border-0"
                      >
                        <span className="text-gray-700">{item.place}</span>
                        <span className="font-semibold text-[#1e3a5f] bg-white px-3 py-1 rounded-full text-sm">
                          {item.distance}
                        </span>
                      </div>
                    ))}
              ...
              <TabsContent value="resorts" className="mt-0">
                <div className="bg-[#f8f7f4] rounded-2xl p-6">
                  <h4 className="font-display font-semibold text-lg text-[#1e3a5f] mb-4 flex items-center gap-2">
                    <Hotel className="w-5 h-5 text-[#c9a962]" />
