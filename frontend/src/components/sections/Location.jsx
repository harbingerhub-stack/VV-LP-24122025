          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            <div className="relative rounded-2xl overflow-hidden shadow-xl h-full min-h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <h3 className="font-display text-2xl text-white mb-3">Hebballi</h3>
                ...
                <div className="space-y-3">
                  {locationData.whyChoose.map((item, index) => (
                    <div key={index} className="flex gap-3">
                      <div className="w-5 h-5 rounded-full bg-[#87b04a] flex items-center justify-center flex-shrink-0 mt-0.5">
