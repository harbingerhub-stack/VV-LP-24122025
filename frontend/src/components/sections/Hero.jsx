    ...
    <section id="home" className="relative min-h-screen flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex items-end justify-center px-4 pb-4">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className={`font-display text-4xl sm:text-5xl md:text-5xl lg:text-6xl text-white mb-3 transition-all duration-1000 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            {heroData.headline}
          </h1>
          
          <p className={`text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-4 font-light leading-relaxed transition-all duration-1000 delay-100 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
