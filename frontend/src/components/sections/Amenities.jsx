      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="glass rounded-xl p-5">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      <p className="font-display text-2xl font-bold text-[#084a61]">20+</p>
                      <p className="text-gray-600 text-sm">Amenities</p>
                    </div>
                    <div className="border-x border-[#e8d5a3]">
                      <p className="font-display text-2xl font-bold text-[#084a61]">24/7</p>
                      <p className="text-gray-600 text-sm">Security</p>
                    </div>
                    <div>
                      <p className="font-display text-2xl font-bold text-[#084a61]">Eco</p>
            ...
            {/* Decorative Frame */}
            <div className="absolute -bottom-4 -right-4 w-32 h-32 border-2 border-[#87b04a]/30 rounded-br-2xl"></div>
          </div>
          ...
          <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
                ...
                <button
                  ...
                  className={`px-5 py-2 rounded-full font-medium text-sm transition-all duration-300 ${
                    activeCategory === index
                      ? 'bg-[#084a61] text-white shadow-lg'
                      : 'bg-white text-[#084a61] hover:bg-[#084a61]/10'
                  }`}
                >
                  {category.name}
                </button>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {amenitiesData.categories[activeCategory].items.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-10 h-10 rounded-lg bg-[#87b04a]/10 group-hover:bg-[#87b04a]/20 flex items-center justify-center flex-shrink-0 transition-colors">
                        <Icon className="w-5 h-5 text-[#87b04a]" />
                      </div>
            ...
            {/* Highlight */}
            <div className="mt-6 bg-[#084a61] rounded-xl p-5 text-white">
              <p className="text-sm leading-relaxed">
                <span className="text-[#87b04a] font-semibold">Sustainable Living:</span> Our community features rainwater harvesting, sewage treatment plants, EV charging stations, and themed landscapes - blending eco-friendly practices with premium living.
              </p>
            </div>
          </div>
        </div>
